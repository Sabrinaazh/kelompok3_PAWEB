...
<body>
    <div class="isi">
        <div class="header">
            ...
            <div class="link">
                <a href="transaksi.php">HOME</a> <a href="list_transaksi.php">LIST TRANSAKSI</a> <a href="logout.php">LOGOUT</a>
                    ...
                    ?>
                        <div class="card">
                            ...
                            <div class="card__details">
                                ...
                                <form action="" method="post">
                                    <button type="submit" class="pesan" name="pesan">Pesan Barang</button>
